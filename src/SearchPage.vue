        ...
        <div class="row p-3 h-100 d-flex align-items-center">
            ...
            <div class="col-8 col-lg-4 bg-dark text-light p-4 h-75 rounded shadow d-flex justify-content-between flex-column align-items-center" style="--mdb-bg-opacity: 0.7;">
                <div class="w-100 text-center mb-3">
                    ...
                    <p class="text-warning fw-bold">WEATHER</p>
                    <hr>
                </div>
                <div class="w-75 text-center">
                    <div class="form-outline">
                        <div class="text-start text-muted">Entrez le nom de la ville</div>
                    ...
                    <button type="button" class="btn btn-outline-warning mt-3" data-mdb-ripple-color="warning" @click="search()">Chercher</button>
                </div>
                <div class="w-100 text-end">
                    <hr>
                    <span class="text-muted">Made by Ahmed Ghribi</span>
                </div>
            </div>
            <div class="col-2 col-lg-4"></div>
        </div>
