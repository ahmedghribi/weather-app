...
export default {
    ...
    async mounted() {
        ...
        if(this.$route.query.city == undefined || this.$route.query.city == null) {
            ...
            await axios.get('https://api.openweathermap.org/data/2.5/weather?q=' + city + '&appid=' +'f825344b0cf0672c689378549f9868db' +'&lang=fr&units=metric')
                .then(response => {
            ...
            await axios.get('https://api.openweathermap.org/data/2.5/forecast?q=' + city + '&appid=' + 'f825344b0cf0672c689378549f9868db' +'&units=metric&lang=fr')
                .then(response => {
